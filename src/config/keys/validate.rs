...
pub(super) fn resolve_key_overrides(
    ...
    let raw = vec![
        ...
        RawBinding {
            name: "create_archive",
            action: Action::CreateArchive,
            override_value: overrides.create_archive,
            default: defaults.create_archive.clone(),
        },
        RawBinding {
            name: "extract_archive",
            action: Action::ExtractArchive,
            override_value: overrides.extract_archive,
            default: defaults.extract_archive.clone(),
        },
        RawBinding {
        ...
        RawBinding {
            name: "rename_in_editor",
            action: Action::RenameInEditor,
            override_value: overrides.rename_in_editor,
            default: defaults.rename_in_editor.clone(),
        },
        RawBinding {
        ...
        RawBinding {
            ...
            action: Action::FilterDirectory,
            override_value: overrides.filter_directory,
            default: defaults.filter_directory.clone(),
        },
        RawBinding {
            name: "find_duplicates",
            action: Action::FindDuplicates,
            override_value: overrides.find_duplicates,
            default: defaults.find_duplicates.clone(),
        },
        RawBinding {
            name: "zoxide",
        ...
        RawBinding {
            ...
            override_value: overrides.toggle_preview,
    ...
    KeyBindings {
        ...
        cut: resolved(3),
        paste: resolved(4),
        create_archive: resolved(5),
        extract_archive: resolved(6),
        symlink_absolute: resolved(7),
        symlink_relative: resolved(8),
        trash: resolved(9),
        delete_permanently: resolved(10),
        create: resolved(11),
        rename: resolved(12),
        rename_in_editor: resolved(13),
        restore_from_trash: resolved(14),
        copy_path: resolved(15),
        search_folders: resolved(16),
        search_files: resolved(17),
        filter_directory: resolved(18),
        find_duplicates: resolved(19),
        zoxide: resolved(20),
        shell: resolved(21),
        open: resolved(22),
        open_with: resolved(23),
        open_or_enter: resolved(24),
        go_to: resolved(25),
        toggle_selection: resolved(26),
        cycle_places_next: resolved(27),
        cycle_places_previous: resolved(28),
        go_parent: resolved(29),
        page_up: resolved(30),
        page_down: resolved(31),
        jump_first: resolved(32),
        jump_last: resolved(33),
        select_all: resolved(34),
        history_back: resolved(35),
        history_forward: resolved(36),
        sort: resolved(37),
        toggle_view: resolved(38),
        toggle_preview: resolved(39),
        fullscreen_preview: resolved(40),
        toggle_hidden: resolved(41),
        nav_left: resolved(42),
        nav_down: resolved(43),
        nav_up: resolved(44),
        nav_right: resolved(45),
        scroll_preview_left: resolved(46),
